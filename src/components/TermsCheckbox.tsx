  ...
  return (
    <>
      <label className="flex items-start gap-3 cursor-pointer">
        <input
          type="checkbox"
          className="mt-0.5 h-4 w-4 rounded border-zinc-600 flex-shrink-0 cursor-pointer"
          checked={checked}
      ...
      {modalOpen && (
        ...
        >
          <div
            className="bg-zinc-900 border border-zinc-700 rounded-2xl w-full max-w-sm max-h-[70vh] flex flex-col shadow-xl"
